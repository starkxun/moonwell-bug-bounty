...
contract mipb50 is HybridProposal, Configs {
    ...
    uint256 public constant totalCampaignAmount = 4000000000000000000000000; // 4M WELL tokens
    ...
    uint256 public constant STKWELL_AMOUNT = 950000000000000000000000; // 950K WELL
