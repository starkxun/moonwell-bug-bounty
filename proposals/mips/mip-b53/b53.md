...
ETH when reducing reserves. However, the TEMPORAL_GOVERNOR on Base does not have
a receive() function (unlike Optimism), which prevents it from receiving native
ETH during proposal execution, causing reserve reduction operations to fail.
